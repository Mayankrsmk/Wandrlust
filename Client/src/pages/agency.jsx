...
const Agency = () => {
    ...
    useEffect(() => {
        const getAllAgencies = async () => {
            const res = await fetch("https://wandrlust-9d93.onrender.com/agency/getAllAgency", {
                method: "GET",
                headers: {
    ...
    const handleEnroll = async (agencyId) => {
        ...
        const res = await fetch(`https://wandrlust-9d93.onrender.com/agency/enroll/${agencyId}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const handleUnEnroll = async (agencyId) => {
        console.log(agencyId);
        const res = await fetch(`https://wandrlust-9d93.onrender.com/agency/unenroll/${agencyId}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
